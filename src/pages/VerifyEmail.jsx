  ...
  return (
    ...
    >
      ...
      <form onSubmit={verify} className="space-y-4">
        ...
        <Button type="submit" disabled={loading || code.length !== 6 || !email} className="h-11 w-full bg-primary font-black uppercase tracking-wide text-primary-foreground hover:bg-primary/90">
